...
class MinionB(BaseMinion):
    def __init__(self, position, orientation, world, image=JACKAL, speed=MYSPEED, viewangle=360, hitpoints=MYHITPOINTS,
                 firerate=FIRERATE, bulletclass=MeleeBullet):
...
ATTACK_ORDER = [Building, CastleBase]
